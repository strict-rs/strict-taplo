...
pub enum TaploCommand {
  ...
  ///
  /// Files are modified in-place unless the input comes from the standard input, in which case the
  /// formatted result is printed to the standard output.
...
pub struct GetCommand {
  ...
  ///
  /// If the value is an integer or float, it will be output in a decimal format without any
  /// rounding.
  ///
